...
function HexagonBackground({
    ...
    return (
        <div
            ...
            className={cn(
                'relative size-full overflow-hidden dark:bg-black bg-neutral-100',
                className,
            )}
            {...props}
        >
                            ...
                            (_, colIndex) => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        "before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full dark:before:bg-neutral-900 before:bg-white before:opacity-100 before:transition-all before:duration-1000",
                                        "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] dark:after:bg-black after:bg-white",
